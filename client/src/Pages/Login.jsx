  ...
  return (
    <div className='h-[100vh] w-full flex items-center justify-center bg-slate-50 px-10 py-10'>
        <div className=' w-[25%] rounded-xl flex flex-col items-center justify-center px-6 py-6 bg-slate-100'>
          ...
          <h1>Sign In</h1>
          <form onSubmit={submitHandler} action="" className='w-full flex flex-col mt-5 items-center justify-center'>
              <input onInput={inputHandler} type="email" name="email" id="" className='mb-6 px-6 py-2 text-base font-normal w-full rounded-lg placeholder:text-sky-500 placeholder:text-xl placeholder:font-medium tracking-wider focus:outline-none' placeholder='email' />
